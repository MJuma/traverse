import { Text, Button, Tooltip, tokens, Dropdown, Option, OptionGroup, makeStyles } from '@fluentui/react-components';
import {
    PlayRegular,
    StopRegular,
...
import { listDatabases, getPersistedDatabases } from '../../services/schema';
...
export function EditorToolbar({ showCancel, onRun, onCancel, onRecall, onFormat, connections, focusedConnection }: EditorToolbarProps) {
    ...
    const listboxProp = useMemo(() => ({ className: dropdownStyles.listbox }), [dropdownStyles.listbox]);
    ...
    // Database dropdown state (uses persistent cache for instant load)
            ...
            <div className={styles.toolbar}>
                <div className={styles.toolbarLeft}>
                    {showCancel ? (
                        ...
                        <Tooltip content={hasSelection ? 'Run Selection (Ctrl+Shift+Enter)' : 'Run Query (Ctrl+Shift+Enter)'} relationship="label">
