...
vi.mock('@fluentui/react-icons', () => ({
    ...
    ArrowSyncRegular: () => React.createElement('span', null, '🔄'),
}));
...
const baseProps = {
    conn: baseConn, idx: 0, canDelete: true, databases: ['DB1', 'DB2'], dbLoading: false, dbLoadFailed: false, isDragOver: false,
    isNew: false, validationStatus: 'none' as const,
    onUpdate: vi.fn(), onRemove: vi.fn(), onLoadDatabases: vi.fn(), onRefreshSchema: vi.fn(), onDragStart: vi.fn(), onDragOver: vi.fn(), onDragEnd: vi.fn(),
};
